...
app.use(
    cors({
        origin: ["*", "http://localhost:3000", 'https://man1sh.tech' ,'http://localhost:5173', "https://sharma-manish.netlify.app", 'https://sharma-manish.onrender.com', 'https://portfolio-mern-360.onrender.com'], // Allow your frontend origins
